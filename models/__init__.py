from .db import (
    ...
    carregar_servicos, carregar_operadores, carregar_areas_operacionais,
    carregar_parametros_novos, carregar_caracteristicas, carregar_tipos_sistema,
    carregar_tipos_veiculo, carregar_tipos_propulsao, carregar_grupamentos, carregar_oficios,
